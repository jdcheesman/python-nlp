...
class PCFGParser(BaselineParser):
    ...
    def train(self, train_trees):
        ...
        #       most binary
        binary_trees = copy.deepcopy(train_trees)
        cnt = 0
        for cnt in range(0, len(binary_trees)):
            binary_trees[cnt] = TreeAnnotations.annotate_tree(binary_trees[cnt])
    ...
    def get_best_parse(self, sentence):
        ...
        # don't forget to debinarize tree
        return None
